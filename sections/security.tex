...
C[0]_{\simid} \gets \dkgchal \cdot
        ...
        \item Generate a simulated an online extractable zero-knowledge proof $\pi_\simid$ (following Figure~\ref{fg:concrete-simulator}) for the relation $\mathcal{R}_P$ w.r.t.\@ $C[0]_\simid$.
